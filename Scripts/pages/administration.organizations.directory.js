...
$(document).ready(function () {
    new OrganizationInvitationPage().pageStart();
...
var OrganizationInvitationPage = /** @class */ (function () {
    function OrganizationInvitationPage() {
    }
    OrganizationInvitationPage.prototype.pageStart = function () {
        this.setupItemDialog("#copyRegistrationLinkDialog");
        this.setupItemDialog("#emailRegistrationDialog");
    };
    OrganizationInvitationPage.prototype.setupItemDialog = function (dlg, handler) {
        var dialog;
    ...
    return OrganizationInvitationPage;
}());
//# sourceMappingURL=administration.organizations.directory.js.map