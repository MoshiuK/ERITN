...
$(document).ready(function () {
    new AttributesPage().pageStart();
});
var AttributesPage = /** @class */ (function () {
    function AttributesPage() {
    }
    AttributesPage.prototype.pageStart = function () {
        var _this = this;
    ...
    AttributesPage.prototype.setupItemDialog = function (dlg, handler) {
        var dialog;
    ...
    AttributesPage.prototype.setupInstrumentEditing = function (dialog, initialSelection) {
        ...
        if (initialSelection !== undefined && initialSelection !== null) {
            ...
            AttributesPage.loadInstrumentEditor(dialog, initialSelection.typeId, initialSelection.id);
        }
        else {
            select.on("select2:select", function (e) {
                var selection = e.params.data;
                AttributesPage.loadInstrumentEditor(dialog, selection.id);
            });
        }
    };
    AttributesPage.loadInstrumentEditor = function (dialog, propertyTypeId, propertyId) {
...
//# sourceMappingURL=administration.person.attributes.js.map